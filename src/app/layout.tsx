...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Ziproh Compliance Centre | The Better Way to Care",
    description: "340+ auto-updated policies, audit tools, and eLearning for UK care providers. Stay CQC inspection-ready, every day.",
    url: APP_URL,
  ...
  twitter: {
    ...
    description: "340+ auto-updated policies, audit tools, and eLearning for UK care providers.",
